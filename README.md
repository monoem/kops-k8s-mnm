...
```sh
aws s3 mb s3://mnm.fr.k8s --region eu-west-3
```
...
```sh
export KOPS_CLUSTER_NAME=mnm.fr
export KOPS_STATE_STORE=s3://mnm.fr.k8s
```
...
--node-size=t2.micro \
--zones=ap-eu-west-1a,eu-west-1b \
